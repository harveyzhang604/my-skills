...
- `image_prompt` must include the exact visible bilingual bubble/caption text, not only a generic instruction to add bubbles. Choose the text by story need: what helps the learner understand the background, visible character activity, task/conflict, emotional turn, or next action. This can be a key dialogue line, a short inner-thought caption, or a concise narrative caption derived from the page.
